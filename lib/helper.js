...
const extendsMixIn = wd => {
  ...
  wd.addPromiseChainMethod('useDataHubSdkApi', function() {
    this.__useDataHubSdkApi = true;
  });
  ...
  wd.addPromiseChainMethod('switchScene', function({
    ...
    if (this.__useDataHubSdkApi && datahubClient.switchScene) {
      return datahubClient.switchScene(...Array.from(arguments));
    }
  ...
  wd.addPromiseChainMethod('switchMultiScenes', function(data = []) {
    if (this.__useDataHubSdkApi && datahubClient.switchMultiScenes) {
      return datahubClient.switchMultiScenes(...Array.from(arguments));
    }
  ...
  wd.addPromiseChainMethod('switchAllScenes', function({
    ...
    if (this.__useDataHubSdkApi && datahubClient.switchAllScenes) {
      return datahubClient.switchAllScenes(...Array.from(arguments));
    }
