...
/**
 * Query the server's current status.(all)
...
/**
 * Returns a list of the currently active sessions.(all)
...
/**
 * Get the current context.(iOS,Android)
 * @returns {Promise.<string>}
 */
function currentContext() {}

/**
 * Set the current context.(iOS,Android)
...
/**
 * Get a list of the available contexts.(iOS,Android)
 * @returns {Promise.<Array>} A list of available contexts.
 */
function contexts() {}

/**
 * Set the amount of time the driver should wait when searching for elements.(all)
...
/**
 * Take a screenshot of the current page.(all)
 * @returns {Promise.<string>} The screenshot as a base64 encoded PNG.
 */
function takeScreenshot() {}

/**
 * Save the screenshot of the current page.(all)
...
/**
 * Get the current page source.(all)
...
/**
 * Move the mouse by an offset of the specificed element.(Android)
...
/**
 * Search for an element on the page, starting from the document root.(all)
...
/**
 * Search for multiple elements on the page, starting from the document root.(all)
...
/**
 * All the element-related methods above (except which suffixed with OrNull, IfExists) could be prefixed with the "waitFor-" (need to capitalize the 'e', e.g., waitForElementByClassName)(all)
...
/**
 * Send a sequence of key strokes to the active element.(all)
...
/**
 * Send a sequence of key strokes to the active window.(Android)
 * @param {string} keys The keys sequence to be sent.
 * @returns {Promise}
 */
function keys(keys) {}
...
/**
 * Returns the visible text for the element.(all)
 * @returns {Promise.<string>}
 */
function text() {}
...
/**
 * Clear a TEXTAREA or text INPUT element's value.(all)
...
/**
 * Determine if an element is currently displayed.(Android, Electron)
 * @returns {Promise.<string>}
 */
function isDisplayed() {}

/**
 * Get the value of an web element's attribute.(Electron)
...
/**
 * Get the result of a property of a element.(Android)
...
/**
 * Query the value of an element's computed CSS property.(Electron)
...
/**
 * Single tap on the touch enabled device.(Android, iOS)
 * @returns {Promise.<string>}
 */
function tap() {}

/**
 * Flick on the touch screen using finger motion events.(iOS)
 * @param xoffset
 * @param yoffset
 * @param speed
 * @returns {Promise.<string>}
...
/**
 * Swipe on the touch screen using finger motion events.(Android, iOS)
 * @param startX {number}
 * @param StartY {number}
 * @param endX {number}
 * @param endY {number}
...
/**
 * Inject a snippet of JavaScript into the page for execution in the context of the currently selected frame.(Electron, iOS)
...
/**
 * Get the current page title.(Electron, iOS)
...
/**
 * Accepts the currently displayed alert dialog.(iOS)
...
/**
 * Dismisses the currently displayed alert dialog.(iOS)
...
/**
 * Gets the text of the currently displayed JavaScript alert(), confirm(), or prompt() dialog.(iOS)
...
/**
 * Sends keystrokes to a JavaScript prompt() dialog.(iOS)
...
/**
 * Retrieve the URL of the current page.(Electron, iOS)
...
/**
 * Navigate forwards in the browser history, if possible.(electron, iOS)
...
/**
 * Navigate backwards in the browser history, if possible.(all)
...
/**
 * Refresh the current page.(electron, iOS)
...
/**
 * Change focus to another window.(electron, iOS)
...
/**
 * Retrieve the current window handle.(iOS)
...
/**
 * Retrieve the list of all window handles available to the session.(electron, iOS)
...
/**
 * Get the size of the specified window.(Android)
...
/**
 * Change the size of the specified window.(electron)
...
/**
 * Maximize the specified window if not already maximized.(electron)
...
/**
 * Change focus to another frame on the page.(electron, iOS)
