...
/**
 * Adds a single cookie to the cookie store associated with the active document’s address. {name:'foo', value:'bar'} Optional cookie fields: path, domain, secure, expiry
 * @summary Support: Web(WebView)
